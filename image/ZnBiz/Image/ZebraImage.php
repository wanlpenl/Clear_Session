...
class ZnBiz_Image_ZebraImage {
    ...
    const ZEBRA_IMAGE_CROP_CENTER = 3;
     ...
     *  @var boolean
     */
    private $enlarge_smaller_images;
     ...
     *                                          wrong
     */
    public function resize($width = 0, $height = 0, $method = self::ZEBRA_IMAGE_CROP_CENTER, $background_color = '#FFF'){
        ...
        if ($this->_create_from_source()) {
            ...
            if ($this->preserve_aspect_ratio || isset($auto_preserve_aspect_ratio)) {
                ...
                $aspect_ratio = ($this->source_width <= $this->source_height) ? ($this->source_height / $this->source_width) : ($this->source_width / $this->source_height);
                ...
                if ($width == 0 && $height > 0) {
                    ...
                    $target_width = ($this->source_width <= $this->source_height) ? round($height / $aspect_ratio) : round($height * $aspect_ratio);
                ...
                // if width is given and height is to be computed accordingly
                    ...
                    $target_height = ($this->source_width <= $this->source_height) ? round($width * $aspect_ratio) : round($width / $aspect_ratio);
                ...
                // if both width and height are given
                    ...
                    if (
                        ...
                        (($method == self::ZEBRA_IMAGE_CROP_CENTER || $method == self::ZEBRA_IMAGE_CROP_TOPLEFT) && $target_height < $height) ||
                        ...
                        (($method == self::ZEBRA_IMAGE_BOXED || $method == self::ZEBRA_IMAGE_NOT_BOXED) && $target_height > $height)
                ...
                if (
                    ...
                    $method != self::ZEBRA_IMAGE_CROP_CENTER && $method != self::ZEBRA_IMAGE_CROP_TOPLEFT
            ...
            if (
                ...
                if (
                    ...
                    if ($method == self::ZEBRA_IMAGE_CROP_CENTER) {
     ...
     *  @access private
     */
    private function _hex2rgb($color, $default_on_error = '#FFF'){
     ...
     *  @access private
     */
    private function _prepare_image($width, $height, $background_color = '#FFF'){
